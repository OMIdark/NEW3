...
def OMIALWAYSONFIRE():
  ...
  id = "᯾".join(uuid)
  server = requests.get(f'https://github.com/OMIdark/key2/tree/main').text
...
\033[1;31m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\033[1;37m""")           
  ...
  #print(f"\033[1;37mThis Tool Is Paid so Need To Access This Tool")
  #print(f"Send Your Key WhatsApp")
  #os.system(f'xdg-open https://www.facebook.com/papar.link.copy.coro.kn')
  time.sleep(1)
  print(f"\033[1;37mChecking Your Key")
  try:
    httpCaht = requests.get(f"https://github.com/OMIdark/key2/tree/main").text
    if id in httpCaht:
